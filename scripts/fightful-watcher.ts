...
export function sanitizeWrestlingTerms(text: string): string {
  ...
  const cleaned = text
    ...
    .replace(arWord("(?:الامرك?نو\\s*الكبير|الأمريكانو\\s*الكبير|الجراندي\\s*امريكانو|إل\\s*جراندي\\s*أمريكانو|الغراندي\\s*امريكانو)"), "إل غراندي أمريكانو")
...
- **باقي عناصر العنوان (المصارعين، الأحداث، البطولات، الألقاب، الأفعال، التفاصيل)**:
  ...
  - **قاعدة الالتزام التام بالحقائق وتفاصيل الخبر الأصلية وعدم اختلاق المفاجآت أو التهويل الفارغ (Factual Truth & Zero Hallucinated Clickbait - حاسمة جداً)**:
    ...
    - جميع أسماء المصارعين والنجوم تُكتب بالعربية حصراً، بما في ذلك الأسماء المختصرة أو التي تبدأ بحرف مفرد:
      ...
      - **حظر تام وقاطع للترجمة الحرفية لأسماء المصارعين والشخصيات المقنعة والترفيهية (Luchadores, Personas & Gimmicks)**:
        ...
        - جميع الأسماء تُكتب حصراً **بالتعريب الصوتي الفصيح**:
          ...
          - أي اسم مقنع أو إسباني (Luchador) يُعرب صوتياً بدقة (مثل: إل غراندي أمريكانو، ميستيكو، بينتا، ري فينيكس).
