...
function sanitizeWrestlingTerms(text: string): string {
  ...
  const cleaned = text
    ...
    .replace(/\bمهرجانات\b/g, "عروض")
    .replace(/\bالمهرجانات\b/g, "العروض")
    .replace(/\bبالمهرجانات\b/g, "بالعروض")
    .replace(/\bللمهرجانات\b/g, "للعروض")
    .replace(/\bمهرجان\b/g, "عرض")
    .replace(/\bالمهرجان\b/g, "العرض")
    .replace(/\bبالمهرجان\b/g, "بالعرض")
    .replace(/\bللمهرجان\b/g, "للعرض")
    ...
    .replace(/\bحلقات\b/g, "عروض")
    .replace(/\bالحلقات\b/g, "العروض")
    ...
    .replace(/\bAJ\s*Lee\b/gi, "ايه جيه لي")
    .replace(/\b(?:اي|إي|أى|أي)\s+لي\b/g, "ايه جيه لي")
    .replace(/\b(?:اي|إي)\s*جاي\s*لي\b/g, "ايه جيه لي")
    .replace(/\b(?:اي|إي)\s*جي\s*لي\b/g, "ايه جيه لي")
    .replace(/\bAJ\s*Styles\b/gi, "ايه جيه ستايلز")
    .replace(/\b(?:اي|إي)\s*ستايلز\b/g, "ايه جيه ستايلز")
    .replace(/\b(?:اي|إي)\s*جي\s*ستايلز\b/g, "ايه جيه ستايلز")
    .replace(/\b(?:اي|إي)\s*جاي\s*ستايلز\b/g, "ايه جيه ستايلز")
    .replace(/\bCJ\s*Perry\b/gi, "سي جيه بيري")
    .replace(/\b(?:سي\s*جاي\s*بيري|سي\s*جي\s*بيري)\b/g, "سي جيه بيري")
    ...
    .replace(/\bقسم\s+النساء\b/g, "قسم السيدات")
    .replace(/\bمصارعة\s+النساء\b/g, "مصارعة السيدات")
    .replace(/\bبطولة\s+النساء\b/g, "بطولة السيدات")
    ...
    .replace(/\b(?:انقرادي|أنقرادي)\s+(?:ال\s+|إل\s+)?(?:إيدولو|ايدولو)\b/gi, "أندرادي إل إيدولو")
    .replace(/\b(?:انقرادي|أنقرادي)\b/g, "أندرادي")
    ...
    // 9. Enforce Arabic names for Tag Teams & Factions (teams and factions must be strictly in Arabic)
    ...
    // 10. Enforce Arabic for Championship Titles without duplicating federation acronym inside the title
    // E.g. "AAA World Tag Team" -> "بطولة العالم للزوجي"
    ...
    .replace(/\bبطولة\s+(?:AAA|WWE|AEW|TNA|ROH|NJPW|MLW)\s+World\s+Tag\s+Team\b/gi, "بطولة العالم للزوجي")
    .replace(/\bبطولة\s+(?:AAA|WWE|AEW|TNA|ROH|NJPW|MLW)\s+(?:للفرق|للزوجي)\b/gi, "بطولة العالم للزوجي");
