...
2. **الأمانة التامة لوقائع العنوان الأصلي**:
   - ممنوع إضافة أي وقائع أو تفاصيل أو تكهنات لم ترد في العنوان الأصلي.
   - إذا كان العنوان الأصلي يحتوي على نزال محدد (فلان ضد فلان على لقب كذا في عرض كذا)، اذكره بالأسماء الصريحة والمباشرة.
   - إذا كان العنوان الأصلي يحتوي على تاريخ (مثل 9/18 أو 9/23)، اذكره بوضوح بالعربية (مثل: "بتاريخ 18 سبتمبر" أو "في 23 سبتمبر").
   - إذا كان العنوان الأصلي يحتوي على تصريح لمصارع، اذكر اسم المصارع والاقتباس بوضوح بين علامتي تنصيص.
   - إذا كان العنوان الأصلي يحتوي على حدث أو إصابة أو ظهور، اذكره مباشرة كما هو (مثل: "تيفاني ستراتون تتعرض لسقوط مخيف فوق الحبل العلوي" أو "سامي زين يظهر في عرض WWE SmackDown بتاريخ 18 سبتمبر").
